...
function CategoryItem({ name, image }) {
  return (
    <div className="relative w-full h-[200px] bg-slate-200 dark:bg-slate-800 rounded-xl group cursor-pointer transition-all duration-200 hover:scale-95 hover:bg-slate-300 dark:hover:bg-slate-900 hover:border-x-4 dark:border-white border-black hover:px-4">
