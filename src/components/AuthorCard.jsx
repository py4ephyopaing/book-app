  ...
  return (
    <div className='w-full px-4 lg:px-10 py-10 shadow-md md:flex gap-x-4'>
        ...
        <div className='text-center md:text-left'>
            <p className="text-2xl font-medium font-mukta dark:text-white flex gap-x-4 items-center justify-center md:justify-normal">John Ronald Reuel Tolkien <FaWifi onClick={handleFollow} title='Follow' className='-rotate-45 active:scale-125 hover:text-fuchsia-600' /></p>
